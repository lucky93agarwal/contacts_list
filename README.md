...
Build DEV APK
```
flutter build apk --release --build-name=flutter_contacts_list_1.0.1 --build-number=1
```
...
<img align="left" src = "https://profile-counter.glitch.me/contact_list/count.svg" alt ="Loading">
